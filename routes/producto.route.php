...
Route::put('/productos/update/{id_producto}', [ProductoController::class, 'updateProducto'])->name('producto.update');
Route::delete('/productos/delete/{id_producto}', [ProductoController::class, 'deletProducto'])->name('producto.delete');
...
Route::post('/productos/lotes/create', [LoteController::class, 'create'])->name('lote.store');