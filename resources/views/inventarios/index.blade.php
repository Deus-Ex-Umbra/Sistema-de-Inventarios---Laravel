        ...
        <div class="contenido">
            ...
            <div class="inventario">
                ...
                <a href="{{ route('inventario.productos', $inventario->id) }}">
                    <div class="card">
                        <div class="profile-pic">
                            <img
                                src="{{ asset('images/' . $inventario->ruta_imagen) }}"
                        ...
                        <div class="bottom">
                            <div class="content">
                                <span class="name"
                                    >{{ $inventario->nombre }}</span
                                >
                                <span class="about-me"
                                    >{{ $inventario->descripcion }}</span
                                >
                                <div class="detalles">
                                    <div class="cantidad">
                                        <strong
                                            >{{$inventario->cantidad_total}}</strong
                                        >
                                        <span>Articulos</span>
                                    </div>
                                    <div class="precio">
                            ...
                            <div class="bottom-bottom">
                                <div class="botones">
                                    <a
                                        ...
                                        ><button class="btn open-modal-edit">
                                            <img
                                                src="{{ asset('iconos/editar.svg') }}"
                                                alt="Editar"
                                            /></button
                                    ></a>
                                    <form
                                        action="{{ route('inventario.delete', $inventario->id) }}"
                                        method="post"
                                    >
                                        @csrf @method('DELETE')
                                        <button type="submit" class="btn">
                                            <img
                                                src="{{ asset('iconos/eliminar.svg') }}"
                                                alt="Eliminar"
                                            />
                                        </button>
                                    </form>
                ...
                <a href="{{ route('inventario.create') }}"
                    ><button>Agregar Inventario</button></a
                >
            </div>
        </div>
    </body>
